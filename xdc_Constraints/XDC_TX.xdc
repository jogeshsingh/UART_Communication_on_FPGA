...
set_property PACKAGE_PIN P4 [get_ports {i_TX_valid}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_TX_valid}]
 


## LEDs
##Bank = 34, Pin name = IO_L24N_T3_34,						Sch name = LED0
set_property PACKAGE_PIN T8 [get_ports {o_TX_active}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_TX_active}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {o_TX}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_TX}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {o_RX_DV}]					
...
set_property PACKAGE_PIN V4 [get_ports {o_RX[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[0]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {o_RX[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[1]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {o_RX[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[2]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {o_RX[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[3]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {o_RX[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[4]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {o_RX[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[5]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {o_RX[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[6]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {o_RX[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_RX[7]}]
...
#set_property PACKAGE_PIN N2 [get_ports {seg_en[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {seg_en[4]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
#set_property PACKAGE_PIN N4 [get_ports {seg_en[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {seg_en[5]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
#set_property PACKAGE_PIN L1 [get_ports {seg_en[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {seg_en[6]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
#set_property PACKAGE_PIN M1 [get_ports {seg_en[7]}]					
...
set_property PACKAGE_PIN C4 [get_ports i_Rx_serial]						
...
#set_property PACKAGE_PIN D3 [get_ports i_Rx_serial]						
	#set_property IOSTANDARD LVCMOS33 [get_ports i_Rx_Serial]
